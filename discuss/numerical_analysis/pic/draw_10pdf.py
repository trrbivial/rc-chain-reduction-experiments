...
pdf_filenames = [
    "R=1_C=1e-15_E=SIN.pdf", "R=1_C=1e-15_E=PUL.pdf", "R=1_C=1e-15_E=EXP.pdf",
    "R=1_C=1e-07_E=SIN.pdf", "R=1_C=1e-07_E=PUL.pdf", "R=1_C=1e-07_E=EXP.pdf"
]
...
# 保存输出
output_doc.save("combined_function_thin.pdf")
